        ...
        try {
            ...
            for (const business of data) {
                ...
                businessesToInsert.push({
                    ...
                    // NO created_at or updated_at - they don't exist in the schema
                });
            }
...
async function main() {
    const pipeline = new FinalPipeline();
    ...
    switch (command) {
        ...
        default:
            console.log(`
Final Pipeline - Working with actual database schema

Usage: node pipeline_final.js <command> [options]
...
Examples:
  node pipeline_final.js import
  node pipeline_final.js status
  node pipeline_final.js clear
  node pipeline_final.js export "./backup.xlsx"
            `);
    }
}
