...
async function importBusinessDataFast() {
    try {
        console.log('Starting FAST business data import...');
        ...
        for (const business of data) {
            ...
            businessesToInsert.push({
                ...
                confidence: business['Confidence'] ? parseFloat(business['Confidence']) / 100 : 0.5,
