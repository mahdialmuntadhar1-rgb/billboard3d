        ...
        for (let i = 0; i < data.length; i += batchSize) {
            ...
            for (const business of batch) {
                try {
                    ...
                    if (!name || !category || !city || !governorate) {
                        console.log(`⚠️  Skipping business with missing required fields: ${name || 'Unknown'}`);
                        skippedCount++;
                        continue;
                    }
                    ...
                    const businessData = {
                        ...
                        requested_category: category, // Use the same category as requested
